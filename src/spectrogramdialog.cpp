...
void SpectrogramDialog::resetSoundfile()
{
    soundfile.reset();
...
void SpectrogramDialog::loadSoundfile()
{
...
void SpectrogramDialog::updateSoundfile()
{
    if (soundfileOk())
    {
...
bool SpectrogramDialog::soundfileOk()
{
    return soundfile.valid();
}

void SpectrogramDialog::choosePalette()
{
...
void SpectrogramDialog::chooseSoundfile()
{
    QString filename = QFileDialog::getOpenFileName(this, 
...
void SpectrogramDialog::makeSpectrogram()
{
    if (!soundfileOk())
    {
...
void SpectrogramDialog::loadValues()
{
...
void SpectrogramDialog::newSpectrogram()
{
...
void SpectrogramDialog::workingState()
{
...
void SpectrogramDialog::idleState()
{
    ui.specProgress->setValue(0);
    ui.specStatus->setText("Idle");
...
void SpectrogramDialog::setFilterUnits(int index)
{
...
void SpectrogramDialog::chooseImage()
{
    QString filename = QFileDialog::getOpenFileName(this, 
...
bool SpectrogramDialog::imageOk()
{
    return !image.isNull();
}

void SpectrogramDialog::loadImage()
{
...
void SpectrogramDialog::resetImage()
{
...
void SpectrogramDialog::saveSoundfile(const real_vec& signal)
{
    QString filename;
...
void SpectrogramDialog::makeSound()
{
    if (!imageOk())
    {
...
void SpectrogramDialog::newSound()
{
...
void SpectrogramDialog::setValues()
{
...
bool SpectrogramDialog::checkAnalysisValues()
{
    QStringList errors;
...
bool SpectrogramDialog::confirmWarnings(const QStringList& errors)
{
    if (errors.size())
    {
        QMessageBox msg;
...
bool SpectrogramDialog::checkSynthesisValues()
{
    QStringList errors;
    size_t badcolors = 0;
