...
static const uint qt_meta_data_ChannelPalette[] = {
 ...
 // slots: signature, parameters, type, tag, flags
    ...
    1111,   15,   15,   15, 0x0a,
    1126,   15,   15,   15, 0x0a,
    1174, 1152,   15,   15, 0x0a,
    1223, 1212,   15,   15, 0x0a,
    1278, 1256,   15,   15, 0x0a,
    1312,  479,   15,   15, 0x0a,
    1346, 1336,   15,   15, 0x0a,
    1363, 1336,   15,   15, 0x0a,
    1397, 1385,   15,   15, 0x0a,
    1426,   15,   15,   15, 0x0a,
    1453, 1445,   15,   15, 0x0a,
    1507, 1471,   15,   15, 0x0a,
    1536,  479,   15,   15, 0x0a,
    1572,   15,   15,   15, 0x0a,
    1588,  637,   15,   15, 0x09,
    1649, 1633,   15,   15, 0x09,
    1689, 1675,   15,   15, 0x09,
    1719,   15,   15,   15, 0x09,
    1737,   15,   15,   15, 0x09,
    1757, 1754,   15,   15, 0x09,
    1774,   15,   15,   15, 0x09,
    1801, 1792,   15,   15, 0x09,
    1873, 1829,   15,   15, 0x09,

       0        // eod
};

static const char qt_meta_stringdata_ChannelPalette[] = {
    "ChannelPalette\0\0selectedChannel\0"
    "singleChangeColor(int)\0groupId\0"
    "groupChangeColor(int)\0shownChannels\0"
    "updateShownChannels(QList<int>)\0"
    "hiddenChannels\0updateHideChannels(QList<int>)\0"
    "parentWidth,labelSize\0paletteResized(int,int)\0"
    "discarded\0channelsDiscarded(QList<int>)\0"
    "dragAndDrop\0setDragAndDrop(bool)\0"
    "groupModified()\0channelIds,afterId,beforeFirst\0"
    "channelsMovedToTrash(QList<int>,QString,bool)\0"
    "channelsToDiscard,afterId,beforeFirst\0"
    "channelsMovedAroundInTrash(QList<int>,QString,bool)\0"
    "channelIds\0channelsRemovedFromTrash(QList<int>)\0"
    "selectedChannels\0channelsSelected(QList<int>)\0"
    "slotRowInsered()\0item,single\0"
    "changeColor(QListWidgetItem*,bool)\0"
    "item\0changeColor(QListWidgetItem*)\0"
    "createGroup()\0grey\0setGreyScale(bool)\0"
    "deleteEmptyGroups()\0selectAllChannels()\0"
    "deselectAllChannels()\0targetGroup,after\0"
    "slotChannelsMoved(QString,QListWidgetItem*)\0"
    "channelIds,sourceGroup,after\0"
    "slotChannelsMoved(QList<int>,QString,QListWidgetItem*)\0"
    "trashChannelsMovedAround(QList<int>,QString,bool)\0"
    "discardChannels()\0channelsToDiscard\0"
    "discardChannels(QList<int>)\0"
    "discardChannels(QList<int>,QString,bool)\0"
    "discardSpikeChannels()\0showChannels()\0"
    "hideChannels()\0hideUnselectAllChannels()\0"
    "channelIds,showStatus\0"
    "updateShowHideStatus(QList<int>,bool)\0"
    "skipStatus\0updateSkipStatus(QMap<int,bool>)\0"
    "channelIds,skipStatus\0"
    "updateSkipStatus(QList<int>,bool)\0"
    "updateColor(QList<int>)\0channelId\0"
    "updateColor(int)\0updateGroupColor(int)\0"
    "paletteType\0applyGroupColor(PaletteType)\0"
    "applyCustomColor()\0edition\0setEditMode(bool)\0"
    "sourceId,targetId,start,destination\0"
    "groupToMove(int,int,int,int)\0"
    "removeChannelsFromTrash(QList<int>)\0"
    "selectionTool()\0"
    "slotMousePressMiddleButton(QListWidgetItem*)\0"
    "sourceGroupName\0slotMousePressed(QString)\0"
    "sourceGroupId\0slotMidButtonPressed(QString)\0"
    "slotClickRedraw()\0languageChange()\0"
    "id\0createGroup(int)\0setChannelLists()\0"
    "position\0slotDragLabeltMoved(QPoint)\0"
    ",sourceGroup,destinationGroup,index,moveAll\0"
    "slotMoveListItem(QList<int>,QString,QString,int,bool)\0"
};
...
void ChannelPalette::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        ChannelPalette *_t = static_cast<ChannelPalette *>(_o);
        switch (_id) {
...
const QMetaObjectExtraData ChannelPalette::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject ChannelPalette::staticMetaObject = {
    { &QScrollArea::staticMetaObject, qt_meta_stringdata_ChannelPalette,
      qt_meta_data_ChannelPalette, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &ChannelPalette::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_ChannelPalette))
        return static_cast<void*>(const_cast< ChannelPalette*>(this));
...
static const char qt_meta_stringdata_SpaceWidget[] = {
    "SpaceWidget\0\0sourceId,targetId,start,destination\0"
    "dropLabel(int,int,int,int)\0dragDrop\0"
...
void SpaceWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Q_ASSERT(staticMetaObject.cast(_o));
        SpaceWidget *_t = static_cast<SpaceWidget *>(_o);
        switch (_id) {
...
const QMetaObjectExtraData SpaceWidget::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject SpaceWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_SpaceWidget,
      qt_meta_data_SpaceWidget, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &SpaceWidget::getStaticMetaObject() { return staticMetaObject; }
#endif //Q_NO_DATA_RELOCATION
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_SpaceWidget))
        return static_cast<void*>(const_cast< SpaceWidget*>(this));
...
static const char qt_meta_stringdata_GroupLabel[] = {
    "GroupLabel\0\0sourceId\0middleClickOnLabel(QString)\0"
    "leftClickOnLabel(QString)\0"
};
...
void GroupLabel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Q_ASSERT(staticMetaObject.cast(_o));
        GroupLabel *_t = static_cast<GroupLabel *>(_o);
        switch (_id) {
...
const QMetaObjectExtraData GroupLabel::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject GroupLabel::staticMetaObject = {
    { &QLabel::staticMetaObject, qt_meta_stringdata_GroupLabel,
      qt_meta_data_GroupLabel, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &GroupLabel::getStaticMetaObject() { return staticMetaObject; }
#endif //Q_NO_DATA_RELOCATION
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_GroupLabel))
        return static_cast<void*>(const_cast< GroupLabel*>(this));
