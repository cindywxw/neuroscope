...
static const char qt_meta_stringdata_PrefDefaults[] = {
    "PrefDefaults\0\0updateTraceBackgroundImage()\0"
};
...
void PrefDefaults::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        PrefDefaults *_t = static_cast<PrefDefaults *>(_o);
        switch (_id) {
...
const QMetaObjectExtraData PrefDefaults::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject PrefDefaults::staticMetaObject = {
    { &PrefDefaultsLayout::staticMetaObject, qt_meta_stringdata_PrefDefaults,
      qt_meta_data_PrefDefaults, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &PrefDefaults::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_PrefDefaults))
        return static_cast<void*>(const_cast< PrefDefaults*>(this));
